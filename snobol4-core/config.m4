...
if test "$PHP_SNOBOL" != "no"; then
  PHP_NEW_EXTENSION(snobol, php_snobol.c snobol_compiler.c snobol_pattern.c snobol_vm.c snobol_jit.c snobol_table.c snobol_table_php.c snobol_dynamic_pattern.c snobol_dynamic_pattern_php.c snobol_ast.c snobol_lexer.c snobol_parser.c, $ext_shared)
fi
