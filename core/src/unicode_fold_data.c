/**
 * @file unicode_fold_data.c
 * @brief Auto-generated BMP case folding tables
 *
 * Generated by dev/gen_unicode_fold.c from Unicode CaseFolding.txt.
 * Do not edit by hand. Regenerate with: make gen-unicode-fold
 */
...
static const FoldPair BMP_UPPER_TO_LOWER[] = {
    ...
    {0x0058, 0x0078}, {0x0059, 0x0079}, {0x005A, 0x007A}, {0x00B5, 0x03BC},
    ...
    {0x017D, 0x017E}, {0x017F, 0x0073}, {0x0181, 0x0253}, {0x0182, 0x0183},
    ...
    {0x024E, 0x024F}, {0x0345, 0x03B9}, {0x0370, 0x0371}, {0x0372, 0x0373},
    ...
    {0x03A9, 0x03C9}, {0x03AA, 0x03CA}, {0x03AB, 0x03CB}, {0x03C2, 0x03C3},
    {0x03CF, 0x03D7}, {0x03D0, 0x03B2}, {0x03D1, 0x03B8}, {0x03D5, 0x03C6},
    {0x03D6, 0x03C0}, {0x03D8, 0x03D9}, {0x03DA, 0x03DB}, {0x03DC, 0x03DD},
    {0x03DE, 0x03DF}, {0x03E0, 0x03E1}, {0x03E2, 0x03E3}, {0x03E4, 0x03E5},
    {0x03E6, 0x03E7}, {0x03E8, 0x03E9}, {0x03EA, 0x03EB}, {0x03EC, 0x03ED},
    {0x03EE, 0x03EF}, {0x03F0, 0x03BA}, {0x03F1, 0x03C1}, {0x03F4, 0x03B8},
    ...
    {0x10CD, 0x2D2D}, {0x13F8, 0x13F0}, {0x13F9, 0x13F1}, {0x13FA, 0x13F2},
    {0x13FB, 0x13F3}, {0x13FC, 0x13F4}, {0x13FD, 0x13F5}, {0x1C80, 0x0432},
    {0x1C81, 0x0434}, {0x1C82, 0x043E}, {0x1C83, 0x0441}, {0x1C84, 0x0442},
    {0x1C85, 0x0442}, {0x1C86, 0x044A}, {0x1C87, 0x0463}, {0x1C88, 0xA64B},
    ...
    {0x1E92, 0x1E93}, {0x1E94, 0x1E95}, {0x1E9B, 0x1E61}, {0x1E9E, 0x00DF},
    ...
    {0x1FBC, 0x1FB3}, {0x1FBE, 0x03B9}, {0x1FC8, 0x1F72}, {0x1FC9, 0x1F73},
    {0x1FCA, 0x1F74}, {0x1FCB, 0x1F75}, {0x1FCC, 0x1FC3}, {0x1FD3, 0x0390},
    {0x1FD8, 0x1FD0}, {0x1FD9, 0x1FD1}, {0x1FDA, 0x1F76}, {0x1FDB, 0x1F77},
    {0x1FE3, 0x03B0}, {0x1FE8, 0x1FE0}, {0x1FE9, 0x1FE1}, {0x1FEA, 0x1F7A},
    {0x1FEB, 0x1F7B}, {0x1FEC, 0x1FE5}, {0x1FF8, 0x1F78}, {0x1FF9, 0x1F79},
    {0x1FFA, 0x1F7C}, {0x1FFB, 0x1F7D}, {0x1FFC, 0x1FF3}, {0x2126, 0x03C9},
    {0x212A, 0x006B}, {0x212B, 0x00E5}, {0x2132, 0x214E}, {0x2160, 0x2170},
    {0x2161, 0x2171}, {0x2162, 0x2172}, {0x2163, 0x2173}, {0x2164, 0x2174},
    {0x2165, 0x2175}, {0x2166, 0x2176}, {0x2167, 0x2177}, {0x2168, 0x2178},
    {0x2169, 0x2179}, {0x216A, 0x217A}, {0x216B, 0x217B}, {0x216C, 0x217C},
    {0x216D, 0x217D}, {0x216E, 0x217E}, {0x216F, 0x217F}, {0x2183, 0x2184},
    ...
    {0x24CE, 0x24E8}, {0x24CF, 0x24E9}, {0x2C00, 0x2C30}, {0x2C01, 0x2C31},
    ...
    {0x2C2E, 0x2C5E}, {0x2C2F, 0x2C5F}, {0x2C60, 0x2C61}, {0x2C62, 0x026B},
    {0x2C63, 0x1D7D}, {0x2C64, 0x027D}, {0x2C67, 0x2C68}, {0x2C69, 0x2C6A},
    {0x2C6B, 0x2C6C}, {0x2C6D, 0x0251}, {0x2C6E, 0x0271}, {0x2C6F, 0x0250},
    {0x2C70, 0x0252}, {0x2C72, 0x2C73}, {0x2C75, 0x2C76}, {0x2C7E, 0x023F},
    {0x2C7F, 0x0240}, {0x2C80, 0x2C81}, {0x2C82, 0x2C83}, {0x2C84, 0x2C85},
    {0x2C86, 0x2C87}, {0x2C88, 0x2C89}, {0x2C8A, 0x2C8B}, {0x2C8C, 0x2C8D},
    {0x2C8E, 0x2C8F}, {0x2C90, 0x2C91}, {0x2C92, 0x2C93}, {0x2C94, 0x2C95},
    {0x2C96, 0x2C97}, {0x2C98, 0x2C99}, {0x2C9A, 0x2C9B}, {0x2C9C, 0x2C9D},
    {0x2C9E, 0x2C9F}, {0x2CA0, 0x2CA1}, {0x2CA2, 0x2CA3}, {0x2CA4, 0x2CA5},
    {0x2CA6, 0x2CA7}, {0x2CA8, 0x2CA9}, {0x2CAA, 0x2CAB}, {0x2CAC, 0x2CAD},
    {0x2CAE, 0x2CAF}, {0x2CB0, 0x2CB1}, {0x2CB2, 0x2CB3}, {0x2CB4, 0x2CB5},
    {0x2CB6, 0x2CB7}, {0x2CB8, 0x2CB9}, {0x2CBA, 0x2CBB}, {0x2CBC, 0x2CBD},
    {0x2CBE, 0x2CBF}, {0x2CC0, 0x2CC1}, {0x2CC2, 0x2CC3}, {0x2CC4, 0x2CC5},
    {0x2CC6, 0x2CC7}, {0x2CC8, 0x2CC9}, {0x2CCA, 0x2CCB}, {0x2CCC, 0x2CCD},
    {0x2CCE, 0x2CCF}, {0x2CD0, 0x2CD1}, {0x2CD2, 0x2CD3}, {0x2CD4, 0x2CD5},
    {0x2CD6, 0x2CD7}, {0x2CD8, 0x2CD9}, {0x2CDA, 0x2CDB}, {0x2CDC, 0x2CDD},
    {0x2CDE, 0x2CDF}, {0x2CE0, 0x2CE1}, {0x2CE2, 0x2CE3}, {0x2CEB, 0x2CEC},
    {0x2CED, 0x2CEE}, {0x2CF2, 0x2CF3}, {0xA640, 0xA641}, {0xA642, 0xA643},
    ...
    {0xA66C, 0xA66D}, {0xA680, 0xA681}, {0xA682, 0xA683}, {0xA684, 0xA685},
    {0xA686, 0xA687}, {0xA688, 0xA689}, {0xA68A, 0xA68B}, {0xA68C, 0xA68D},
    {0xA68E, 0xA68F}, {0xA690, 0xA691}, {0xA692, 0xA693}, {0xA694, 0xA695},
    {0xA696, 0xA697}, {0xA698, 0xA699}, {0xA69A, 0xA69B}, {0xA722, 0xA723},
    {0xA724, 0xA725}, {0xA726, 0xA727}, {0xA728, 0xA729}, {0xA72A, 0xA72B},
    {0xA72C, 0xA72D}, {0xA72E, 0xA72F}, {0xA732, 0xA733}, {0xA734, 0xA735},
    ...
    {0xA76E, 0xA76F}, {0xA779, 0xA77A}, {0xA77B, 0xA77C}, {0xA77D, 0x1D79},
    {0xA77E, 0xA77F}, {0xA780, 0xA781}, {0xA782, 0xA783}, {0xA784, 0xA785},
    {0xA786, 0xA787}, {0xA78B, 0xA78C}, {0xA78D, 0x0265}, {0xA790, 0xA791},
    ...
    {0xA7AB, 0x025C}, {0xA7AC, 0x0261}, {0xA7AD, 0x026C}, {0xA7AE, 0x026A},
    {0xA7B0, 0x029E}, {0xA7B1, 0x0287}, {0xA7B2, 0x029D}, {0xA7B3, 0xAB53},
    {0xA7B4, 0xA7B5}, {0xA7B6, 0xA7B7}, {0xA7B8, 0xA7B9}, {0xA7BA, 0xA7BB},
    {0xA7BC, 0xA7BD}, {0xA7BE, 0xA7BF}, {0xA7C0, 0xA7C1}, {0xA7C2, 0xA7C3},
    {0xA7C4, 0xA794}, {0xA7C5, 0x0282}, {0xA7C6, 0x1D8E}, {0xA7C7, 0xA7C8},
    {0xA7C9, 0xA7CA}, {0xA7CB, 0x0264}, {0xA7CC, 0xA7CD}, {0xA7CE, 0xA7CF},
    {0xA7D0, 0xA7D1}, {0xA7D2, 0xA7D3}, {0xA7D4, 0xA7D5}, {0xA7D6, 0xA7D7},
    {0xA7D8, 0xA7D9}, {0xA7DA, 0xA7DB}, {0xA7DC, 0x019B}, {0xA7F5, 0xA7F6},
    ...
    {0xFB05, 0xFB06}, {0xFF21, 0xFF41}, {0xFF22, 0xFF42}, {0xFF23, 0xFF43},
...
static const size_t N_BMP_UPPER_TO_LOWER =
    sizeof(BMP_UPPER_TO_LOWER) / sizeof(BMP_UPPER_TO_LOWER[0]);

static const FoldPair BMP_LOWER_TO_UPPER[] = {
    ...
    {0x0079, 0x0059}, {0x007A, 0x005A}, {0x00DF, 0x1E9E}, {0x00E0, 0x00C0},
    ...
    {0x019A, 0x023D}, {0x019B, 0xA7DC}, {0x019E, 0x0220}, {0x01A1, 0x01A0},
    {0x01A3, 0x01A2}, {0x01A5, 0x01A4}, {0x01A8, 0x01A7}, {0x01AD, 0x01AC},
    {0x01B0, 0x01AF}, {0x01B4, 0x01B3}, {0x01B6, 0x01B5}, {0x01B9, 0x01B8},
    {0x01BD, 0x01BC}, {0x01BF, 0x01F7}, {0x01C6, 0x01C4}, {0x01C6, 0x01C5},
    {0x01C9, 0x01C8}, {0x01C9, 0x01C7}, {0x01CC, 0x01CB}, {0x01CC, 0x01CA},
    ...
    {0x01ED, 0x01EC}, {0x01EF, 0x01EE}, {0x01F3, 0x01F2}, {0x01F3, 0x01F1},
    ...
    {0x0264, 0xA7CB}, {0x0265, 0xA78D}, {0x0266, 0xA7AA}, {0x0268, 0x0197},
    ...
    {0x037B, 0x03FD}, {0x037C, 0x03FE}, {0x037D, 0x03FF}, {0x0390, 0x1FD3},
    {0x03AC, 0x0386}, {0x03AD, 0x0388}, {0x03AE, 0x0389}, {0x03AF, 0x038A},
    {0x03B0, 0x1FE3}, {0x03B1, 0x0391}, {0x03B2, 0x03D0}, {0x03B2, 0x0392},
    {0x03B3, 0x0393}, {0x03B4, 0x0394}, {0x03B5, 0x03F5}, {0x03B5, 0x0395},
    {0x03B6, 0x0396}, {0x03B7, 0x0397}, {0x03B8, 0x03F4}, {0x03B8, 0x03D1},
    {0x03B8, 0x0398}, {0x03B9, 0x1FBE}, {0x03B9, 0x0399}, {0x03B9, 0x0345},
    {0x03BA, 0x03F0}, {0x03BA, 0x039A}, {0x03BB, 0x039B}, {0x03BC, 0x039C},
    {0x03BC, 0x00B5}, {0x03BD, 0x039D}, {0x03BE, 0x039E}, {0x03BF, 0x039F},
    {0x03C0, 0x03A0}, {0x03C0, 0x03D6}, {0x03C1, 0x03A1}, {0x03C1, 0x03F1},
    {0x03C3, 0x03A3}, {0x03C3, 0x03C2}, {0x03C4, 0x03A4}, {0x03C5, 0x03A5},
    {0x03C6, 0x03D5}, {0x03C6, 0x03A6}, {0x03C7, 0x03A7}, {0x03C8, 0x03A8},
    {0x03C9, 0x2126}, {0x03C9, 0x03A9}, {0x03CA, 0x03AA}, {0x03CB, 0x03AB},
    {0x03CC, 0x038C}, {0x03CD, 0x038E}, {0x03CE, 0x038F}, {0x03D7, 0x03CF},
    ...
    {0x03F2, 0x03F9}, {0x03F3, 0x037F}, {0x03F8, 0x03F7}, {0x03FB, 0x03FA},
    {0x0430, 0x0410}, {0x0431, 0x0411}, {0x0432, 0x1C80}, {0x0432, 0x0412},
    {0x0433, 0x0413}, {0x0434, 0x1C81}, {0x0434, 0x0414}, {0x0435, 0x0415},
    {0x0436, 0x0416}, {0x0437, 0x0417}, {0x0438, 0x0418}, {0x0439, 0x0419},
    {0x043A, 0x041A}, {0x043B, 0x041B}, {0x043C, 0x041C}, {0x043D, 0x041D},
    {0x043E, 0x041E}, {0x043E, 0x1C82}, {0x043F, 0x041F}, {0x0440, 0x0420},
    {0x0441, 0x0421}, {0x0441, 0x1C83}, {0x0442, 0x0422}, {0x0442, 0x1C85},
    {0x0442, 0x1C84}, {0x0443, 0x0423}, {0x0444, 0x0424}, {0x0445, 0x0425},
    {0x0446, 0x0426}, {0x0447, 0x0427}, {0x0448, 0x0428}, {0x0449, 0x0429},
    {0x044A, 0x1C86}, {0x044A, 0x042A}, {0x044B, 0x042B}, {0x044C, 0x042C},
    ...
    {0x0463, 0x0462}, {0x0463, 0x1C87}, {0x0465, 0x0464}, {0x0467, 0x0466},
    ...
    {0x0481, 0x0480}, {0x048B, 0x048A}, {0x048D, 0x048C}, {0x048F, 0x048E},
    ...
    {0x0511, 0x0510}, {0x0513, 0x0512}, {0x0515, 0x0514}, {0x0517, 0x0516},
    {0x0519, 0x0518}, {0x051B, 0x051A}, {0x051D, 0x051C}, {0x051F, 0x051E},
    {0x0521, 0x0520}, {0x0523, 0x0522}, {0x0525, 0x0524}, {0x0527, 0x0526},
    {0x0529, 0x0528}, {0x052B, 0x052A}, {0x052D, 0x052C}, {0x052F, 0x052E},
    ...
    {0x0585, 0x0555}, {0x0586, 0x0556}, {0x10D0, 0x1C90}, {0x10D1, 0x1C91},
    {0x10D2, 0x1C92}, {0x10D3, 0x1C93}, {0x10D4, 0x1C94}, {0x10D5, 0x1C95},
    {0x10D6, 0x1C96}, {0x10D7, 0x1C97}, {0x10D8, 0x1C98}, {0x10D9, 0x1C99},
    {0x10DA, 0x1C9A}, {0x10DB, 0x1C9B}, {0x10DC, 0x1C9C}, {0x10DD, 0x1C9D},
    {0x10DE, 0x1C9E}, {0x10DF, 0x1C9F}, {0x10E0, 0x1CA0}, {0x10E1, 0x1CA1},
    {0x10E2, 0x1CA2}, {0x10E3, 0x1CA3}, {0x10E4, 0x1CA4}, {0x10E5, 0x1CA5},
    {0x10E6, 0x1CA6}, {0x10E7, 0x1CA7}, {0x10E8, 0x1CA8}, {0x10E9, 0x1CA9},
    {0x10EA, 0x1CAA}, {0x10EB, 0x1CAB}, {0x10EC, 0x1CAC}, {0x10ED, 0x1CAD},
    {0x10EE, 0x1CAE}, {0x10EF, 0x1CAF}, {0x10F0, 0x1CB0}, {0x10F1, 0x1CB1},
    {0x10F2, 0x1CB2}, {0x10F3, 0x1CB3}, {0x10F4, 0x1CB4}, {0x10F5, 0x1CB5},
    {0x10F6, 0x1CB6}, {0x10F7, 0x1CB7}, {0x10F8, 0x1CB8}, {0x10F9, 0x1CB9},
    {0x10FA, 0x1CBA}, {0x10FD, 0x1CBD}, {0x10FE, 0x1CBE}, {0x10FF, 0x1CBF},
    ...
    {0x13F4, 0x13FC}, {0x13F5, 0x13FD}, {0x1C8A, 0x1C89}, {0x1D79, 0xA77D},
    ...
    {0x1E5D, 0x1E5C}, {0x1E5F, 0x1E5E}, {0x1E61, 0x1E60}, {0x1E61, 0x1E9B},
    ...
    {0x1E93, 0x1E92}, {0x1E95, 0x1E94}, {0x1EA1, 0x1EA0}, {0x1EA3, 0x1EA2},
    ...
    {0x1FB0, 0x1FB8}, {0x1FB1, 0x1FB9}, {0x1FB3, 0x1FBC}, {0x1FC3, 0x1FCC},
    ...
    {0xA64B, 0xA64A}, {0xA64B, 0x1C88}, {0xA64D, 0xA64C}, {0xA64F, 0xA64E},
    ...
    {0xA7C8, 0xA7C7}, {0xA7CA, 0xA7C9}, {0xA7CD, 0xA7CC}, {0xA7CF, 0xA7CE},
    {0xA7D1, 0xA7D0}, {0xA7D3, 0xA7D2}, {0xA7D5, 0xA7D4}, {0xA7D7, 0xA7D6},
    {0xA7D9, 0xA7D8}, {0xA7DB, 0xA7DA}, {0xA7F6, 0xA7F5}, {0xAB53, 0xA7B3},
    {0xFB06, 0xFB05}, {0xFF41, 0xFF21}, {0xFF42, 0xFF22}, {0xFF43, 0xFF23},
...
static const size_t N_BMP_LOWER_TO_UPPER =
...
static const MultiCharExpansion MULTI_CHAR_EXPANSIONS[] = {
    {0x00DF, {0x0053, 0x0053}, 2}, {0x0130, {0x0049, 0x0307}, 2},
    {0x0149, {0x02BC, 0x004E}, 2}, {0x01F0, {0x004A, 0x030C}, 2},
    {0x0390, {0x03B9, 0x0308}, 2}, {0x03B0, {0x03C5, 0x0308}, 2},
    {0x0587, {0x0565, 0x0582}, 2}, {0x1E96, {0x0048, 0x0331}, 2},
    {0x1E97, {0x0054, 0x0308}, 2}, {0x1E98, {0x0057, 0x030A}, 2},
    {0x1E99, {0x0059, 0x030A}, 2}, {0x1E9A, {0x0041, 0x02BE}, 2},
    {0x1E9E, {0x0053, 0x0053}, 2}, {0x1F50, {0x03C5, 0x0313}, 2},
    {0x1F52, {0x03C5, 0x0313}, 2}, {0x1F54, {0x03C5, 0x0313}, 2},
    {0x1F56, {0x03C5, 0x0313}, 2}, {0x1F80, {0x1F00, 0x03B9}, 2},
    {0x1F81, {0x1F01, 0x03B9}, 2}, {0x1F82, {0x1F02, 0x03B9}, 2},
    {0x1F83, {0x1F03, 0x03B9}, 2}, {0x1F84, {0x1F04, 0x03B9}, 2},
    {0x1F85, {0x1F05, 0x03B9}, 2}, {0x1F86, {0x1F06, 0x03B9}, 2},
    {0x1F87, {0x1F07, 0x03B9}, 2}, {0x1F88, {0x1F00, 0x03B9}, 2},
    {0x1F89, {0x1F01, 0x03B9}, 2}, {0x1F8A, {0x1F02, 0x03B9}, 2},
    {0x1F8B, {0x1F03, 0x03B9}, 2}, {0x1F8C, {0x1F04, 0x03B9}, 2},
    {0x1F8D, {0x1F05, 0x03B9}, 2}, {0x1F8E, {0x1F06, 0x03B9}, 2},
    {0x1F8F, {0x1F07, 0x03B9}, 2}, {0x1F90, {0x1F20, 0x03B9}, 2},
    {0x1F91, {0x1F21, 0x03B9}, 2}, {0x1F92, {0x1F22, 0x03B9}, 2},
    {0x1F93, {0x1F23, 0x03B9}, 2}, {0x1F94, {0x1F24, 0x03B9}, 2},
    {0x1F95, {0x1F25, 0x03B9}, 2}, {0x1F96, {0x1F26, 0x03B9}, 2},
    {0x1F97, {0x1F27, 0x03B9}, 2}, {0x1F98, {0x1F20, 0x03B9}, 2},
    {0x1F99, {0x1F21, 0x03B9}, 2}, {0x1F9A, {0x1F22, 0x03B9}, 2},
    {0x1F9B, {0x1F23, 0x03B9}, 2}, {0x1F9C, {0x1F24, 0x03B9}, 2},
    {0x1F9D, {0x1F25, 0x03B9}, 2}, {0x1F9E, {0x1F26, 0x03B9}, 2},
    {0x1F9F, {0x1F27, 0x03B9}, 2}, {0x1FA0, {0x1F60, 0x03B9}, 2},
    {0x1FA1, {0x1F61, 0x03B9}, 2}, {0x1FA2, {0x1F62, 0x03B9}, 2},
    {0x1FA3, {0x1F63, 0x03B9}, 2}, {0x1FA4, {0x1F64, 0x03B9}, 2},
    {0x1FA5, {0x1F65, 0x03B9}, 2}, {0x1FA6, {0x1F66, 0x03B9}, 2},
    {0x1FA7, {0x1F67, 0x03B9}, 2}, {0x1FA8, {0x1F60, 0x03B9}, 2},
    {0x1FA9, {0x1F61, 0x03B9}, 2}, {0x1FAA, {0x1F62, 0x03B9}, 2},
    {0x1FAB, {0x1F63, 0x03B9}, 2}, {0x1FAC, {0x1F64, 0x03B9}, 2},
    {0x1FAD, {0x1F65, 0x03B9}, 2}, {0x1FAE, {0x1F66, 0x03B9}, 2},
};
static const size_t N_MULTI_CHAR =
    sizeof(MULTI_CHAR_EXPANSIONS) / sizeof(MULTI_CHAR_EXPANSIONS[0]);
