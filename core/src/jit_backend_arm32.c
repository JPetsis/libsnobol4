...
#define T2_B_COND(cond, imm11) ((uint16_t)(0xd000u | ((cond) << 8) | ((imm11) & 0xffu)))
...
#define T2_CBZ(rn, imm7) ((uint16_t)(0xb100u | (((imm7) & 0x3fu) << 3) | ((rn) & 7u)))

/* CBNZ <Rn>, <label> — compare and branch if non-zero, range ±126 bytes, encoding T1 */
#define T2_CBNZ(rn, imm7) ((uint16_t)(0xb900u | (((imm7) & 0x3fu) << 3) | ((rn) & 7u)))

/* --- Data-processing (16-bit, low register Rd/Rn/Rm in r0-r7) --- */
#define T2_MOV_RD_RS(rd, rs)  ((uint16_t)(0x4600u | (((rd) & 7u) << 0) | (((rd) & 8u) << 4) | (((rs) & 15u) << 3)))
#define T2_MOVS_RD_IMM8(rd, imm8) ((uint16_t)(0x2000u | (((rd) & 7u) << 8) | ((imm8) & 0xffu)))
#define T2_ADDS_RD_RN_RM(rd, rn, rm) ((uint16_t)(0x1800u | (((rd) & 7u) << 0) | (((rn) & 7u) << 3) | (((rm) & 7u) << 6)))
#define T2_ADD_RD_RS(rd, rs)  ((uint16_t)(0x4400u | (((rd) & 7u) << 0) | (((rd) & 8u) << 4) | (((rs) & 15u) << 3)))
#define T2_ADDS_RD_RN_IMM3(rd, rn, imm3) ((uint16_t)(0x1c00u | (((rd) & 7u) << 0) | (((rn) & 7u) << 3) | (((imm3) & 7u) << 6)))
#define T2_SUBS_RD_RN_RM(rd, rn, rm) ((uint16_t)(0x1a00u | (((rd) & 7u) << 0) | (((rn) & 7u) << 3) | (((rm) & 7u) << 6)))
#define T2_SUBS_RD_RN_IMM3(rd, rn, imm3) ((uint16_t)(0x1e00u | (((rd) & 7u) << 0) | (((rn) & 7u) << 3) | (((imm3) & 7u) << 6)))
#define T2_CMP_RN_RM(rn, rm) ((uint16_t)(0x4280u | (((rn) & 7u) << 3) | (((rm) & 7u) << 6)))
#define T2_CMP_RN_IMM8(rn, imm8) ((uint16_t)(0x2800u | (((rn) & 7u) << 8) | ((imm8) & 0xffu)))
#define T2_ANDS_RD_RM(rd, rm) ((uint16_t)(0x4000u | (((rd) & 7u) << 0) | (((rm) & 7u) << 3)))
#define T2_ORRS_RD_RM(rd, rm) ((uint16_t)(0x4300u | (((rd) & 7u) << 0) | (((rm) & 7u) << 3)))
#define T2_EORS_RD_RM(rd, rm) ((uint16_t)(0x4040u | (((rd) & 7u) << 0) | (((rm) & 7u) << 3)))
#define T2_LSLS_RD_RM_IMM5(rd, rm, imm5) ((uint16_t)(0x0000u | (((rd) & 7u) << 0) | (((rm) & 7u) << 3) | (((imm5) & 0x1fu) << 6)))
#define T2_LSRS_RD_RM_IMM5(rd, rm, imm5) ((uint16_t)(0x0800u | (((rd) & 7u) << 0) | (((rm) & 7u) << 3) | (((imm5) & 0x1fu) << 6)))
#define T2_ASRS_RD_RM_IMM5(rd, rm, imm5) ((uint16_t)(0x1000u | (((rd) & 7u) << 0) | (((rm) & 7u) << 3) | (((imm5) & 0x1fu) << 6)))
...
#define T2_LDR_RT_RN_IMM5(rt, rn, imm5) ((uint16_t)(0x6800u | ((imm5) & 0x1fu) << 6 | ((rn) & 7u) << 3 | ((rt) & 7u)))
/* LDRB <Rt>, [<Rn>, #<imm5>] — 16-bit */
#define T2_LDRB_RT_RN_IMM5(rt, rn, imm5) ((uint16_t)(0x7800u | ((imm5) & 0x1fu) << 6 | ((rn) & 7u) << 3 | ((rt) & 7u)))
/* STR <Rt>, [<Rn>, #<imm5>] — 16-bit */
#define T2_STR_RT_RN_IMM5(rt, rn, imm5) ((uint16_t)(0x6000u | ((imm5) & 0x1fu) << 6 | ((rn) & 7u) << 3 | ((rt) & 7u)))
/* STRB <Rt>, [<Rn>, #<imm5>] — 16-bit */
#define T2_STRB_RT_RN_IMM5(rt, rn, imm5) ((uint16_t)(0x7000u | ((imm5) & 0x1fu) << 6 | ((rn) & 7u) << 3 | ((rt) & 7u)))
/* LDRH <Rt>, [<Rn>, #<imm5>] — 16-bit */
#define T2_LDRH_RT_RN_IMM5(rt, rn, imm5) ((uint16_t)(0x8800u | ((imm5) & 0x1fu) << 6 | ((rn) & 7u) << 3 | ((rt) & 7u)))
/* STRH <Rt>, [<Rn>, #<imm5>] — 16-bit */
#define T2_STRH_RT_RN_IMM5(rt, rn, imm5) ((uint16_t)(0x8000u | ((imm5) & 0x1fu) << 6 | ((rn) & 7u) << 3 | ((rt) & 7u)))

/* LDR <Rt>, [<Rn>, <Rm>] — register offset, 16-bit, all in r0-r7 */
#define T2_LDR_RT_RN_RM(rt, rn, rm) ((uint16_t)(0x5800u | ((rt) & 7u) | (((rn) & 7u) << 3) | (((rm) & 7u) << 6)))
/* LDRB <Rt>, [<Rn>, <Rm>] */
#define T2_LDRB_RT_RN_RM(rt, rn, rm) ((uint16_t)(0x5c00u | ((rt) & 7u) | (((rn) & 7u) << 3) | (((rm) & 7u) << 6)))
/* STR <Rt>, [<Rn>, <Rm>] */
#define T2_STR_RT_RN_RM(rt, rn, rm) ((uint16_t)(0x5000u | ((rt) & 7u) | (((rn) & 7u) << 3) | (((rm) & 7u) << 6)))
/* STRB <Rt>, [<Rn>, <Rm>] */
#define T2_STRB_RT_RN_RM(rt, rn, rm) ((uint16_t)(0x5400u | ((rt) & 7u) | (((rn) & 7u) << 3) | (((rm) & 7u) << 6)))
...
#define t2_emit_split(hi, lo) do { t2_emit16(hi); t2_emit16(lo); } while(0)
...
static void t2_patch_cbz_cbnz(uint8_t *p, uint8_t *target, int rn, bool is_cbnz) {
    intptr_t diff = target - p;
 ...
 */
static void t2_emit_callout(void) {
...
#define EMIT_VOID_CALLOUT(fn_ptr_) do { \
    t2_emit_callout(); \
...
#define EMIT_BOOL_CALLOUT(fn_ptr_, fp_, fpc_, cur_) do { \
    ...
    (fp_)[(*(fpc_))++] = (FailPatch){ t2_emit_patch_b_cond(T2_COND_EQ), (cur_) }; \
} while(0)
    ...
    FailPatch *fail_patches, size_t *fail_patch_count)
{
    ...
    for (size_t i = 0; i < ir->count; i++) {
        ...
        case JIT_IR_LIT: {
            ...
            /* bhi fail */
            fail_patches[(*fail_patch_count)++] = (FailPatch){ t2_emit_patch_b_cond(T2_COND_HI), cur };
            for (uint32_t j = 0; j < lit_len; j++) {
                ...
                /* bne fail */
                fail_patches[(*fail_patch_count)++] = (FailPatch){ t2_emit_patch_b_cond(T2_COND_NE), cur };
                /* add r2, r2, #1 */
        ...
        case JIT_IR_BREAK: case JIT_IR_BREAKX: {
            ...
            t2_emit_mov_imm64_pair(6, 7, ascii_map[0] | ((uint64_t)ascii_map[1] << 32));

            /* Check pos < len */
            t2_emit32(T2_CMP_W_RN_RM(2, 3));
            fail_patches[(*fail_patch_count)++] = (FailPatch){ t2_emit_patch_b_cond(T2_COND_GE), cur };
            ...
            /* Load bitmap word: if bit 6 of char is set, use high map (r7), else low (r6) */
            ...
            if (ins->opcode == JIT_IR_NOTANY) {
                ...
                fail_patches[(*fail_patch_count)++] = (FailPatch){ t2_emit_patch_b_cond(T2_COND_EQ), cur };
            }
        ...
        case JIT_IR_CAP_END: {
            ...
            /* Update max_cap_used */
            t2_emit32(T2_LDRB_W_RT_RN_IMM12(9, 0, (uint32_t)offsetof(VM, max_cap_used)));
            t2_emit_mov_imm32(8, r + 1);
            t2_emit32(T2_CMP_W_RN_RM(9, 8));
            uint8_t *lt_skip = t2_emit_patch_b_cond(T2_COND_GE);
            t2_emit32(T2_STRB_W_RT_RN_IMM12(8, 0, (uint32_t)offsetof(VM, max_cap_used)));
        ...
        case JIT_IR_ASSIGN: {
            ...
            t2_emit32(T2_LDR_W_RT_RN_IMM12(9, 0, (uint32_t)(offsetof(VM, cap_start) + reg * 8)));
            t2_emit32(T2_STR_W_RT_RN_IMM12(9, 0, (uint32_t)(offsetof(VM, var_start) + var * 8)));
            /* Load cap_end[reg] -> var_end[var] */
            t2_emit32(T2_LDR_W_RT_RN_IMM12(9, 0, (uint32_t)(offsetof(VM, cap_end) + reg * 8)));
            t2_emit32(T2_STR_W_RT_RN_IMM12(9, 0, (uint32_t)(offsetof(VM, var_end) + var * 8)));
            /* Update var_count */
        ...
        case JIT_IR_RTAB: {
            ...
            fail_patches[(*fail_patch_count)++] = (FailPatch){ t2_emit_patch_b_cond(T2_COND_LO), cur };
            /* r8 = len - n */
            t2_emit32(T2_SUB_W_RD_RN_RM(8, 3, 4));
            /* Check pos <= r8 */
        ...
        case JIT_IR_FENCE: {
            ...
            t2_emit_mov_imm32(4, 0);
            t2_emit32(T2_STR_W_RT_RN_IMM12(4, 0, (uint32_t)offsetof(VM, choices_top)));
            break;
        }
        ...
        case JIT_IR_TABLE_GET: {
            ...
            t2_emit32(T2_STR_W_RT_RN_IMM12(2, 0, (uint32_t)offsetof(VM, pos)));
            EMIT_BOOL_CALLOUT(snobol_jit_helper_table_get, fail_patches, fail_patch_count, cur);
        ...
        case JIT_IR_BAL: {
            ...
            t2_emit32(T2_STR_W_RT_RN_IMM12(2, 0, (uint32_t)offsetof(VM, pos)));
            EMIT_BOOL_CALLOUT(snobol_jit_helper_bal, fail_patches, fail_patch_count, cur);
            t2_emit32(T2_LDR_W_RT_RN_IMM12(2, 0, (uint32_t)offsetof(VM, pos)));
            break;
        }
        ...
        case JIT_IR_EVAL: {
            ...
            t2_emit32(T2_STR_W_RT_RN_IMM12(2, 0, (uint32_t)offsetof(VM, pos)));
            EMIT_BOOL_CALLOUT(snobol_jit_helper_eval, fail_patches, fail_patch_count, cur);
            t2_emit32(T2_LDR_W_RT_RN_IMM12(2, 0, (uint32_t)offsetof(VM, pos)));
            break;
        }
...
#ifdef SNOBOL_DYNAMIC_PATTERN
            t2_emit32(T2_STR_W_RT_RN_IMM12(2, 0, (uint32_t)offsetof(VM, pos)));
            EMIT_BOOL_CALLOUT(snobol_jit_helper_dynamic, fail_patches, fail_patch_count, cur);
            t2_emit32(T2_LDR_W_RT_RN_IMM12(2, 0, (uint32_t)offsetof(VM, pos)));
#endif
            break;
        }
