...
void test_unicode_fold_suite(void) {
  ...
  test_assert(out_len == 1 && out[0] == 0x00C9,
  ...
  test_assert(out_len == 1 && out[0] == 0x00DC,
  ...
  test_assert(out_len == 1 && out[0] == 0x0178,
  ...
  test_assert(out_len == 1 && out[0] == 0x0160,
  ...
  test_assert(out_len == 1 && out[0] == 0x017D,
              "to_upper: U+017E ž → U+017D Ž");

  /* U+0101 ā → U+0100 Ā */
  snobol_to_upper_cp(0x0101, out, &out_len);
  test_assert(out_len == 1 && out[0] == 0x0100,
  ...
  test_assert(out_len == 1 && out[0] == 0x0400,
  ...
  test_assert(out_len == 1 && out[0] == 0x0410,
  ...
  test_assert(out_len == 1 && out[0] == 0x042F,
  ...
  test_assert(out_len == 1 && out[0] == 0x0391,
  ...
  test_assert(out_len == 1 && out[0] == 0x03A9,
  ...
  test_assert(out_len == 1 && out[0] == 0x0627,
  ...
  test_assert(out_len == 1 && out[0] == 0x05D0,
  ...
  test_assert(out_len == 1 && out[0] == 0x4E2D,
