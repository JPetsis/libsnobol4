...
void test_comparison_suite(void) {
  ...
  test_assert(snobol_lexlt("apple", 5, "banana", 6),
              "LEXLT: 'apple' < 'banana'");
  test_assert(!snobol_lexlt("banana", 6, "apple", 5),
              "LEXLT: 'banana' not < 'apple'");
  test_assert(!snobol_lexlt("equal", 5, "equal", 5),
              "LEXLT: equal strings not <");

  /* --- LEXGT --- */
  test_assert(snobol_lexgt("banana", 6, "apple", 5),
              "LEXGT: 'banana' > 'apple'");
  test_assert(!snobol_lexgt("apple", 5, "banana", 6),
