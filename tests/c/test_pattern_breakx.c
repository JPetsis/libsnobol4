                             ...
                             size_t *out_end_pos)
{
    ...
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0;
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0x3B; /* start = 59 */
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0;
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0x3B; /* end = 59 */
    ...
    bc_off = range_off;
    /* count=1 u16 */
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 1;
    /* case=0 u16 */
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0;
    /* range: start=0x3B, end=0x3B (8 bytes) */
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0;
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0x3B;
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0;
    bc_buf[bc_off++] = 0; bc_buf[bc_off++] = 0x3B;
