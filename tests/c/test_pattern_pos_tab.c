...
void test_pattern_pos_suite(void) {
    ...
    /* POS(3) on "abcde": match at position 3 */
    {
        ...
        uint8_t bc[] = {
            OP_POS,
              (uint8_t)(pos_n >> 24), (uint8_t)(pos_n >> 16),
              (uint8_t)(pos_n >>  8), (uint8_t)(pos_n),
            OP_ACCEPT
        };
        ...
        uint8_t bc2[] = {
            OP_LEN,
              (uint8_t)(len_n >> 24), (uint8_t)(len_n >> 16),
              (uint8_t)(len_n >>  8), (uint8_t)(len_n),
            OP_POS,
              (uint8_t)(pos_n >> 24), (uint8_t)(pos_n >> 16),
              (uint8_t)(pos_n >>  8), (uint8_t)(pos_n),
            OP_ACCEPT
        ...
        uint8_t bc3[] = {
            OP_LEN,
              (uint8_t)(len3 >> 24), (uint8_t)(len3 >> 16),
              (uint8_t)(len3 >>  8), (uint8_t)(len3),
            OP_POS,
              (uint8_t)(pos_n >> 24), (uint8_t)(pos_n >> 16),
              (uint8_t)(pos_n >>  8), (uint8_t)(pos_n),
            OP_LEN,
...
void test_pattern_tab_suite(void) {
    ...
    /* TAB(2) LEN(2) on "abcde": advance to pos=2, match "cd" */
    {
        ...
        uint8_t bc[] = {
            OP_TAB,
              (uint8_t)(tab_n >> 24), (uint8_t)(tab_n >> 16),
              (uint8_t)(tab_n >>  8), (uint8_t)(tab_n),
            OP_LEN,
              (uint8_t)(len_n >> 24), (uint8_t)(len_n >> 16),
              (uint8_t)(len_n >>  8), (uint8_t)(len_n),
            OP_ACCEPT
